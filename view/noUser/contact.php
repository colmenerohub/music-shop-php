...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/music-shop-php/assets/css/contact/contact.css">
    ...
    <body>
        ...
        <main>
            ...
            <img src="/music-shop-php/assets/media/img/atencionCliente.png" alt="">
        </main>
        ...
        <div id="socialMedia">
            <div>
                <h1 class="animate-on-scroll"><a href="https://www.tiktok.com/@brodevs" class="icon-tiktok"
                        style="color: #bc98f3;" target="_blank"></a></h1>
                <h2 class="animate-on-scroll" style="color: #bc98f3;">@brodiscs</h2>
            </div>
            <div>
                <h1 class="animate-on-scroll"><a href="https://www.instagram.com/thebrodevs/" class="icon-instagram"
                        style="color: #84b6f4;" target="_blank"></a></h1>
                <h2 class="animate-on-scroll" style="color: #84b6f4;">@brodiscs</h2>
            </div>
            <div>
                <h1 class="animate-on-scroll"><a href="https://www.youtube.com/channel/UC6E_T_JPbo7Gl1q3OGFBv7A"
                        class="icon-youtube" style="color: #ff6961;" target="_blank"></a></h1>
                <h2 class="animate-on-scroll" style="color: #ff6961;">@brodiscs</h2>
            </div>
            <div>
                <h1 class="animate-on-scroll"><a href="https://open.spotify.com/user/marioneti2004?si=8a4019bed0104564"
                        class="icon-spotify" style="color: lightgreen;" target="_blank"></a></h1>
