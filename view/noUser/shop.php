...
<head>
    ...
    <link rel="stylesheet" href="/MarioMusicShop/assets/css/shop/diskCard.css">
...
<body>
    ...
    <div id='shop-container'>
        <div id='filters'>
            ...
            <?php if (isset($_SESSION['role'])) {
                if($_SESSION["role"] === 'admin') echo '<button id="insertButton" href="">Insertar <span class="icon-plus"></span></button>';
            } ?>
        </div>
    ...
    <script> const role = '<?php if (isset($_SESSION['role'])) echo $_SESSION["role"]; ?>'; </script>
