...
<head>
    ...
    <link rel="stylesheet" href="/MarioMusicShop/assets/css/register/register.css">
...
<body>
    ...
    <div id='registerContainer'>
        <a href="index.php"><img id="bigLogo" src="/MarioMusicShop/assets/media/img/yellowLogo.png" alt=""></a>
        <form id="registerForm" method="POST">
            ...
            <div id='userPasswordContainer'>
                ...
                <div class='passwordInput'>
                    ...
                    <img id="registerPassword_eye" src="/MarioMusicShop/assets/icons/invisiblePassword.svg" alt="">
                </div>
                ...
                <div class='passwordInput'>
                    ...
                    <img id="registerPasswordc_eye" src="/MarioMusicShop/assets/icons/invisiblePassword.svg" alt="">
                </div>
