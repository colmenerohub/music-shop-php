...
<head>
    ...
    <link rel="stylesheet" href="/MarioMusicShop/assets/css/landingPage/landingPage.css">
    <link rel="stylesheet" href="/MarioMusicShop/assets/css/landingPage/card.css">
...
<body>
    ...
    <main>
        <h1><?php echo isset($_SESSION['name']) ? 'Bienvenid@ ' . $_SESSION['name'] .' '. $_SESSION['surnames']  : 'Online Vinyl Store' ?></h1>
    </main>
    ...
    <script src="/MarioMusicShop/assets/js/landingPage/generateAlbumCards.js"></script>
</body>
</html>