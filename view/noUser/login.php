...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/music-shop-php/assets/css/login/login.css">
    ...
    <body>
        <form id="loginForm" method="POST">
            ...
            <div class='passwordInput'>
                ...
                <img id="loginPassword_eye" src="/music-shop-php/assets/icons/invisiblePassword.svg" alt="">
            </div>
        ...
        <img id="bigLogo" src="/music-shop-php/assets/media/img/yellowLogo.png" alt="">
