    ...
    public function getDisksByPage($actualPage)
    {
        ...
        $responseArray = [
            'info' => [
                ...
                'next' => ($actualPage < ceil($totalCount / DISKNUM)) ? "/music-shop-php/controller/disksController.php?page=" . ($actualPage + 1) : null,
                'prev' => ($actualPage > 1) ? "/music-shop-php/controller/disksController.php?page=" . ($actualPage - 1) : null
            ],
            'results' => $disks
        ];
